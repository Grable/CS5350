...
train_data = pd.read_csv("../CS5350-main/CS5350-main/Neural Network/train.csv", header=None)
# process data
...
test_data = pd.read_csv("../CS5350-main/CS5350-main/Neural Network/test.csv", header=None)
